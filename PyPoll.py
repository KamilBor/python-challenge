...
with open('C:\Users\kamil\AppData\Local\Packages\Microsoft.MicrosoftEdge_8wekyb3d8bbwe\TempState\Downloads\python-challenge (10).zip\python-challenge\PyPoll\', 'r') as csvfile:
